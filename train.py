...
parser.add_argument('--number_of_files', type=str, default=5)
args = parser.parse_args()

# Load Data
dataset = NumPyDataset(args.root_dir, generator_b=args.generator_b, number_of_files=args.number_of_files)
